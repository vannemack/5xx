...
-	added the following pages to the me wp site 
	welcome to me (nested the following pages below this one) 
		- home - copied content from header in to this page 
		- about, experience, education, skills, interests, awards, contact - copied the content for each of the pages from the static site
 		- no content added to “welcome to me” page – used as parent for API calls
		- “from me” added to each page to allow for easy validation of successful API calls
